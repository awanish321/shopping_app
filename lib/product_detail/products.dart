...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  Future<void> addToCart() async {
    ...
    if (firstImage.isNotEmpty && selectedColor.isNotEmpty) {
      ...
      return collectionRef.doc(currentUser!.email).collection('items').add(cartItemData)
          .then((value) => print('Added to cart'))
          .catchError((error) => print('Error adding to cart: $error'));
    } else {
                            ...
                            return Positioned(
                              ...
                              child: Container(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () => snapshot.data.docs.length==0?addToFavourite() : debugPrint('Already Added'),
                                ),
                              ),
                            );
                          },
